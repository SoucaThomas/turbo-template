...
export function canAccessFeature(userPlanId: string, requiredFeature: string): boolean {
...
export function getNextUpgradePlan(currentPlanId: string) {
    ...
    const upgradePlans = StripePlans.filter((plan) => plan.price > currentPlan.price);
